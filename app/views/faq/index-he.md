...
* יש לנו מגבלת פרץ של 50 הודעות לכל `Sender` ו-`yourdomain.com` לדקה. זה מונע מספאמרים להציף דומיין במאות הודעות בשנייה גם כאשר המגבלה היומית לא הושגה.

כל מגבלות הקצב נאכפות באופן אטומי — המונים מוגדלים לפני אחסון ההודעה, מה שמבטל מצבי מרוץ שבהם בקשות מקבילות יכולות לעקוף את המגבלות.
