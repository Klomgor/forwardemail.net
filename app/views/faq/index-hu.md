...
* A sebességkorlátokat egy többszintű rendszer alapján alkalmazzuk a küldő megbízhatósági szintje szerint:
  * **1. szint – Megbízható források** (pl. `gmail.com`, `microsoft.com`, `apple.com`): globálisan napi 100 GB-ra korlátozva. Mentesülnek a domainenkénti és a burst korlátok alól.
  * **2. szint – [Engedélyezett](#do-you-have-an-allowlist) küldők**: globálisan napi 10 GB-ra korlátozva. Mentesülnek a domainenkénti és a burst korlátok alól.
  * **3. szint – Minden más küldő**: globálisan napi 1 GB és/vagy 1000 üzenet, `Sender`+domain kombinációnként napi 1 GB és/vagy 1000 üzenet, valamint `Sender`+domain kombinációnként percenként 50 üzenet burst korlát.
* A burst korlát egy fix ablakos számlálót (60 másodperc) használ. Az ablak az első üzenet megérkezésekor indul, és 60 másodperc elteltével lejár, függetlenül a későbbi üzenetektől — nem csúszik és nem indul újra minden üzenetnél.
* Címzettenkénti postaládánként napi 100,000 üzenet felső határt alkalmazunk. Ez minden szintre vonatkozik, és megakadályozza, hogy bármelyik postaládát elárasszák, függetlenül a küldő megbízhatósági szintjétől.

Minden sebességkorlát atomikusan érvényesül — a számlálók az üzenet tárolása előtt növekednek, kiküszöbölve a versenyhelyzeteket, ahol egyidejű kérések megkerülhetnék a korlátokat. A csökkentési műveletek (amelyeket akkor használunk, ha a tárolás a növelés után sikertelen) biztonságos Lua szkripteket használnak, amelyek megakadályozzák, hogy a számlálók negatívba menjenek.
