...
* เรามีขีดจำกัดการส่งแบบต่อเนื่องที่ 50 ข้อความต่อ `Sender` และ `yourdomain.com` ต่อนาที ซึ่งป้องกันไม่ให้ผู้ส่งสแปมท่วมโดเมนด้วยข้อความหลายร้อยข้อความต่อวินาที แม้ว่าจะยังไม่ถึงขีดจำกัดรายวัน

ขีดจำกัดอัตราทั้งหมดถูกบังคับใช้แบบอะตอมิก — ตัวนับจะถูกเพิ่มก่อนที่ข้อความจะถูกจัดเก็บ ซึ่งขจัดสภาวะการแข่งขันที่คำขอพร้อมกันอาจข้ามขีดจำกัดได้
