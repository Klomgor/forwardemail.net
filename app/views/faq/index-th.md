...
* [การตั้งค่าอีเมล](#email-configuration)
  ...
  * [ทำไมรายงาน DMARC ของฉันจึงแสดงความล้มเหลวจากที่อยู่ IP ที่ไม่รู้จัก](#why-do-my-dmarc-reports-show-failures-from-unknown-ip-addresses)
...
* [รายละเอียดระบบและเทคนิค](#system-and-technical-details)
  ...
  * [ขีดจำกัดแบนด์วิดท์ของคุณคืออะไร](#what-are-your-bandwidth-limits)
...
หากรายงาน DMARC ของคุณมีที่อยู่ IP ที่ไม่คุ้นเคยซึ่งล้มเหลวใน SPF และ DKIM **โปรดอย่ากังวล** – นี่เป็นเรื่องปกติและหมายความว่าการตั้งค่าของคุณทำงานได้อย่างถูกต้อง

รายงาน DMARC จะแสดงรายการเซิร์ฟเวอร์ **ทุกเครื่อง** ที่พยายามส่งอีเมลโดยอ้างว่ามาจากโดเมนของคุณ รวมถึงเซิร์ฟเวอร์ที่ไม่ได้รับอนุญาตด้วย ในเกือบทุกกรณี IP ที่ไม่รู้จักเหล่านี้เป็นเพียงผู้ส่งสแปมหรือบอทที่พยายามแอบอ้างเป็นโดเมนของคุณ นี่คือสิ่งที่จะเกิดขึ้นเมื่อพวกเขาพยายาม:

* **SPF ล้มเหลว** เนื่องจาก IP ที่ส่งไม่ได้อยู่ในระเบียน SPF ของคุณ
* **DKIM ล้มเหลว** เนื่องจากพวกเขาไม่สามารถสร้างลายเซ็นที่ถูกต้องสำหรับโดเมนของคุณได้
* ด้วยนโยบาย DMARC ที่เป็น `p=reject` ข้อความจะถูก **ปฏิเสธทันที** และจะไม่ไปถึงกล่องจดหมายของใครเลย

กล่าวอีกนัยหนึ่ง ความล้มเหลวเหล่านี้เป็นข้อพิสูจน์ว่า DMARC กำลังทำหน้าที่ของมัน – บล็อกความพยายามในการแอบอ้างก่อนที่จะก่อให้เกิดอันตราย คุณไม่จำเป็นต้องดำเนินการใดๆ

**วิธีแยกแยะผู้ส่งที่ถูกต้องจากผู้แอบอ้าง**

* อีเมลที่คุณส่งผ่าน Forward Email (หรือบริการที่ได้รับอนุญาตอื่นๆ) จะแสดง SPF และ/หรือ DKIM ว่า **ผ่านและสอดคล้องกัน**
* แหล่งที่มาที่ไม่รู้จักซึ่งล้มเหลว **ทั้ง** SPF และ DKIM คือผู้แอบอ้างและสามารถเพิกเฉยได้อย่างปลอดภัย
* คุณสามารถตรวจสอบที่อยู่ IP เทียบกับ <https://forwardemail.net/ips> เพื่อยืนยันว่าแหล่งที่มาใดเป็นของเรา

หากคุณใช้บริการอื่นๆ เพื่อส่งอีเมลในนามโดเมนของคุณด้วย (เครื่องมือการตลาด, CRM ฯลฯ) ตรวจสอบให้แน่ใจว่าบริการเหล่านั้นมีการกำหนดค่าลายเซ็น DKIM ที่ถูกต้อง – มิฉะนั้นข้อความของพวกเขาจะปรากฏเป็นความล้มเหลวในรายงานของคุณเช่นกัน

> \[!IMPORTANT]
> ตรวจสอบให้แน่ใจว่าโดเมนของคุณเผยแพร่นโยบาย DMARC ที่เป็น `p=reject` เพื่อให้ความพยายามในการแอบอ้างถูกปฏิเสธแทนที่จะถูกส่ง ดู [วิธีตั้งค่า DMARC สำหรับ Forward Email](#how-do-i-set-up-dmarc-for-forward-email)
...
* ในแผนชำระเงินของเรา (การป้องกันขั้นสูงและทีม) คุณสามารถปิดใช้งานการค้นหา WKD ต่อนามแฝงได้ ไปที่การตั้งค่านามแฝงของคุณและเลือกตัวเลือก "ปิดใช้งานการค้นหา WKD" เมื่อปิดใช้งาน อีเมลขาเข้าที่ส่งต่อไปยังนามแฝงนั้นจะไม่ถูกเข้ารหัสผ่าน WKD แม้ว่าจะมีการเผยแพร่คีย์สาธารณะสำหรับผู้รับ สิ่งนี้ยังพร้อมใช้งานผ่าน API โดยใช้ฟิลด์ `has_wkd_disabled`
...
* ขีดจำกัดอัตราจะถูกนำมาใช้โดยใช้ระบบแบ่งระดับตามระดับความน่าเชื่อถือของผู้ส่ง:
  * **Tier 1 – แหล่งข้อมูลที่เชื่อถือได้** (เช่น `gmail.com`, `microsoft.com`, `apple.com`): จำกัดที่ 100 GB ต่อวันทั่วโลก ได้รับการยกเว้นจากขีดจำกัดต่อโดเมนและขีดจำกัดการส่งแบบต่อเนื่อง
  * **Tier 2 – ผู้ส่งที่อยู่ใน [allowlist](#do-you-have-an-allowlist)**: จำกัดที่ 10 GB ต่อวันทั่วโลก ได้รับการยกเว้นจากขีดจำกัดต่อโดเมนและขีดจำกัดการส่งแบบต่อเนื่อง
  * **Tier 3 – ผู้ส่งอื่น ๆ ทั้งหมด**: จำกัดที่ 1 GB และ/หรือ 1000 ข้อความต่อวันทั่วโลก, 1 GB และ/หรือ 1000 ข้อความต่อ `Sender`+โดเมนต่อวัน, และขีดจำกัดการส่งแบบต่อเนื่องที่ 50 ข้อความต่อ `Sender`+โดเมนต่อนาที
* ขีดจำกัดการส่งแบบต่อเนื่องใช้ตัวนับหน้าต่างคงที่ (60 วินาที) หน้าต่างจะเริ่มต้นเมื่อข้อความแรกมาถึงและหมดอายุหลังจาก 60 วินาทีโดยไม่คำนึงถึงข้อความที่ตามมา — มันจะไม่เลื่อนหรือรีเซ็ตในแต่ละข้อความ
* เรามีขีดจำกัดรายวันของกล่องจดหมายต่อผู้รับที่ 100,000 ข้อความ สิ่งนี้ใช้กับทุกระดับและป้องกันไม่ให้กล่องจดหมายใด ๆ ถูกส่งอีเมลล้นกล่องจดหมายโดยไม่คำนึงถึงระดับความน่าเชื่อถือของผู้ส่ง

ขีดจำกัดอัตราทั้งหมดถูกบังคับใช้แบบอะตอมิก — ตัวนับจะถูกเพิ่มก่อนที่ข้อความจะถูกจัดเก็บ ซึ่งขจัดสภาวะการแข่งขันที่คำขอพร้อมกันอาจข้ามขีดจำกัดได้ การดำเนินการลดค่า (ใช้เมื่อการจัดเก็บล้มเหลวหลังจากการเพิ่มค่า) ใช้สคริปต์ Lua ที่ปลอดภัยซึ่งป้องกันไม่ให้ตัวนับติดลบ
...
เราบังคับใช้ขีดจำกัดแบนด์วิดท์ต่อผู้ใช้ในทุกบริการเพื่อป้องกันการโจมตีแบบ flooding ในขณะที่ยังคงเอื้อเฟื้อเพียงพอสำหรับการใช้งานที่ถูกต้อง  ขีดจำกัดเหล่านี้ตั้งใจให้สูงกว่า Gmail มาก — คุณสามารถนำเข้าข้อมูลสำรองขนาดใหญ่ ซิงค์กล่องจดหมายทั้งหมดไปยังอุปกรณ์ใหม่ หรือใช้ไคลเอนต์หลายตัวพร้อมกันโดยไม่พบอุปสรรคใดๆ

| ขีดจำกัด | ขอบเขต | จำนวน |
| :--- | :--- | :---: |
| รวมรายวัน | ทุกบริการรวมกัน (IMAP, POP3, SMTP, CalDAV, CardDAV) | **50 GB** |
| รายชั่วโมงต่อบริการ | ต่อบริการแต่ละรายการ (เช่น ดาวน์โหลด IMAP, อัปโหลด SMTP) | **10 GB** |

ขีดจำกัดรายวันเป็นงบประมาณร่วมเดียวข้ามทุกโปรโตคอล — ไม่ว่าคุณจะดาวน์โหลดผ่าน IMAP อัปโหลดผ่าน SMTP หรือซิงค์ปฏิทินผ่าน CalDAV ทั้งหมดนับรวมใน 50 GB/วัน เดียวกัน  ขีดจำกัดรายชั่วโมงต่อบริการเป็นตาข่ายนิรภัยสำหรับสคริปต์ที่ควบคุมไม่ได้หรือบัญชีที่ถูกบุกรุกบนโปรโตคอลเดียว — ไม่ใช่สิ่งที่ผู้ใช้ที่ถูกต้องควรจะถึง

ขีดจำกัดเหล่านี้เป็นต่อบัญชีผู้ใช้ (ไม่ใช่ต่อ alias หรือโดเมน) และรีเซ็ตทุกวัน  ซึ่งหมายความว่าการสร้าง alias เพิ่มเติมจะไม่เพิ่มโควตาแบนด์วิดท์ของคุณ  หาก Redis ไม่พร้อมใช้งาน การจำกัดอัตราจะถูกข้ามทั้งหมด (fail-open) เพื่อให้บริการของคุณไม่ถูกขัดจังหวะ

หากคุณต้องการขีดจำกัดที่สูงขึ้นสำหรับกรณีการใช้งานเฉพาะ (เช่น การย้ายข้อมูลอาร์ไคฟ์ขนาดใหญ่มาก) กรุณา[ติดต่อเรา](https://forwardemail.net/help)
