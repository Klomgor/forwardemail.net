...
* [Dettagli di Sistema e Tecnici](#system-and-technical-details)
  ...
  * [Quali sono i vostri limiti di larghezza di banda](#what-are-your-bandwidth-limits)
...
* Nei nostri piani a pagamento (Protezione avanzata e Team), è possibile disabilitare la ricerca WKD per singolo alias. Naviga nelle impostazioni del tuo alias e seleziona l'opzione "Disabilita ricerca WKD". Quando disabilitato, le email in arrivo inoltrate a quell'alias non verranno crittografate tramite WKD anche se è pubblicata una chiave pubblica per il destinatario. Questo è disponibile anche tramite API utilizzando il campo `has_wkd_disabled`.
...
```
**Scartare silenziosamente i messaggi indesiderati:**
...
Applichiamo limiti di larghezza di banda per utente su tutti i servizi per prevenire attacchi di flooding pur rimanendo sufficientemente generosi per l'uso legittimo.  Questi limiti sono intenzionalmente ben al di sopra di quelli di Gmail — puoi importare backup di grandi dimensioni, sincronizzare l'intera casella di posta su un nuovo dispositivo o utilizzare più client contemporaneamente senza incontrare alcun ostacolo.

| Limite | Ambito | Quantità |
| :--- | :--- | :---: |
