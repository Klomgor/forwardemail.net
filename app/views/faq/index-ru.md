...
Эти лимиты применяются к каждому псевдониму и сбрасываются ежедневно.  Если Redis недоступен, ограничение скорости полностью пропускается (fail-open), чтобы ваш сервис никогда не прерывался.
