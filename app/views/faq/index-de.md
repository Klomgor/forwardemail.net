...
* In unseren kostenpflichtigen Plänen (Erweiterter Schutz und Team) können Sie die WKD-Suche pro Alias deaktivieren. Navigieren Sie zu Ihren Alias-Einstellungen und aktivieren Sie die Option "WKD-Suche deaktivieren". Wenn deaktiviert, werden eingehende E-Mails, die an diesen Alias weitergeleitet werden, nicht über WKD verschlüsselt, selbst wenn ein öffentlicher Schlüssel für den Empfänger veröffentlicht ist. Dies ist auch über die API mit dem Feld `has_wkd_disabled` verfügbar.
...
```
**Unerwünschte Nachrichten stillschweigend verwerfen:**
