...
* لدينا حد للرشقات يبلغ 50 رسالة لكل `Sender` و `yourdomain.com` في الدقيقة. هذا يمنع مرسلي البريد العشوائي من إغراق النطاق بمئات الرسائل في الثانية حتى عندما لم يتم الوصول إلى الحد اليومي.

يتم تطبيق جميع حدود المعدل بشكل ذري — يتم زيادة العدادات قبل تخزين الرسالة، مما يزيل حالات السباق حيث يمكن للطلبات المتزامنة تجاوز الحدود.
