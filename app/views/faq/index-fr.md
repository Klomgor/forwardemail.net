...
* [Détails Systèmes et Techniques](#system-and-technical-details)
  ...
  * [Quelles sont vos limites de bande passante](#what-are-your-bandwidth-limits)
...
> \[!TIP]
> En savoir plus sur Forward Email en lisant notre [Livre blanc technique](/technical-whitepaper.pdf) gratuit et en consultant notre [audit de sécurité](/pentest-report_forward-email.pdf) par Cure53.
...
* Sur nos plans payants (Protection améliorée et Équipe), vous pouvez désactiver la recherche WKD par alias. Accédez aux paramètres de votre alias et cochez l'option "Désactiver la recherche WKD". Lorsque désactivé, les e-mails entrants transférés vers cet alias ne seront pas chiffrés via WKD même si une clé publique est publiée pour le destinataire. Ceci est également disponible via l'API en utilisant le champ `has_wkd_disabled`.
...
Nous appliquons des limites de bande passante par utilisateur sur tous les services pour prévenir les attaques par inondation tout en restant suffisamment généreux pour une utilisation légitime.  Ces limites sont intentionnellement bien au-dessus de celles de Gmail — vous pouvez importer de grandes sauvegardes, synchroniser toute votre boîte aux lettres sur un nouvel appareil ou utiliser plusieurs clients simultanément sans rencontrer aucun obstacle.

| Limite | Portée | Montant |
| :--- | :--- | :---: |
