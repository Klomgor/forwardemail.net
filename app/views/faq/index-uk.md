...
Ці обмеження застосовуються до кожного псевдоніма і скидаються щодня.  Якщо Redis недоступний, обмеження швидкості повністю пропускається (fail-open), щоб ваш сервіс ніколи не переривався.
