...
* Ми маємо ліміт на сплески — 50 повідомлень на `Sender` і `yourdomain.com` на хвилину. Це запобігає затопленню домену спамерами сотнями повідомлень на секунду, навіть коли денний ліміт не досягнуто.

Усі ліміти швидкості застосовуються атомарно — лічильники збільшуються до збереження повідомлення, що усуває стани гонки, при яких одночасні запити могли б обійти ліміти.
